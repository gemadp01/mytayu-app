            ...
            <div class="col-12">
                <form method="post" action="/dashboard/mahasiswa/{{ $mahasiswa->id }}" >
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="nama" id="nama" placeholder="Nama" autofocus required value="{{ old('nama', $mahasiswa->nama) }}">
                    </div>
                    @error('nama')
                        <div class="invalid-feedback">
                            {{ $message }}
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="kelas" id="kelas" placeholder="Kelas" autofocus required value="{{ old('kelas', $mahasiswa->kelas) }}">
                    </div>
                    @error('kelas')
                        <div class="invalid-feedback">
                            {{ $message }}
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="prodi" id="prodi" placeholder="Prodi" autofocus required value="{{ old('prodi', $mahasiswa->prodi) }}">
                    </div>
                    @error('prodi')
                        <div class="invalid-feedback">
                            {{ $message }}
